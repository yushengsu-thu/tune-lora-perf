...
| JIT cache | `/mnt/nvme-b/sglang-dot-cache` hostPath | `/mnt/stateful_partition/sglang-dot-cache` hostPath (persists; broadcastable via `../Qwen3.5-35B-A3B-FP8/broadcast_jit_cache.sh`) |
