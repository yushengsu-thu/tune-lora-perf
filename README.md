...
4. **Accuracy regression**:
   ...
   - Qwen3.5-35B all-in-one (acc+bench+prompts+profile, single node) — [`qwen35_35b-regression/`](qwen35_35b-regression)
5. **Profile recipes**:
...
7. **E2E full test (experimental TRT-LLM LoRA fast path)**:
