#!/usr/bin/env bash
# Tests-only companion to Kimi-K2.5-NVFP4_run_gb300.sh: assumes a server is ALREADY launched (or warming)
...
# Usage: Kimi-K2.5-NVFP4_tests_only.sh <LORA=0|1> <TAG> <TESTS=full|gsm8k_only>
