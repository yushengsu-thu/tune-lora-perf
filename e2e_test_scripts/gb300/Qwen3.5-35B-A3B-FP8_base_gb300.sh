#!/usr/bin/env bash
# GB300 port of ../gb200/Qwen3.5-35B-A3B-FP8_base.sh (oss-main no-LoRA ceiling, default backend = %-denominator).
# Deltas vs GB200: READY wait 175->225 iters (45 min, cold sm_103 JIT headroom) +
# flashinfer pin guard (see Qwen3.5-35B-A3B-FP8_run_gb300.sh header).
# Usage: Qwen3.5-35B-A3B-FP8_base_gb300.sh <TAG>
