#!/usr/bin/env bash
# GB300 (sm_103, gcp-radixark-02) port of ../gb200/Qwen3.5-35B-A3B-FP8_run.sh. Deltas vs GB200:
...
# Usage: Qwen3.5-35B-A3B-FP8_run_gb300.sh <REF=full-lora-opti|main> <TAG>
