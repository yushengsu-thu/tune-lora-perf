...
| PR moe backend parameterized: `PRBACKEND` (default `sgl_flashinfer_trtllm`) | `jybsuper:full-lora-opti` naming; post-PR-#27329-merge refs call it `experimental_sgl_trtllm` — set `PRBACKEND` to match the ref under test |
