#!/usr/bin/env bash
# QWEN oss-main no-LoRA baseline: same setup as the e2e MINUS lora args, with --moe-runner-backend UNSPECIFIED (default).
# Usage: Qwen3.5-35B-A3B-FP8_base.sh <TAG>   (lorapr-1, already on oss main)
